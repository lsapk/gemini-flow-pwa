...
export const usePersonalityProfile = () => {
  ...
  const generateProfile = async () => {
    ...
    try {
      ...
      // Profil par défaut au lieu d'appeler l'API pour éviter les erreurs
      const defaultProfile: PersonalityProfile = {
        personality: {
          traits: ["organisé", "motivé", "persévérant"],
          strengths: ["discipline", "focus"],
          areas_to_improve: ["équilibre", "patience"],
          motivations: ["réussite", "amélioration"],
          working_style: "méthodique"
        },
        psychological_insights: {
          behavioral_patterns: ["planification", "exécution"],
          stress_management: "organisation structure",
          decision_making_style: "analytique réfléchi",
          social_preferences: "indépendant concentré"
        },
        productivity_analysis: {
          peak_performance_times: ["matin", "début après-midi"],
          productivity_blockers: ["distractions", "perfectionnisme"],
          optimal_work_environment: "calme organisé",
          goal_achievement_style: "étapes progressives"
        },
        recommendations: {
          habits_to_develop: ["pause régulière", "exercice physique", "méditation"],
          productivity_tips: ["timeboxing", "priorités matrix", "pauses actives"],
          personal_growth: ["lecture développement", "réflexion quotidienne"],
          stress_management: ["respiration", "organisation", "temps libre"]
        },
        growth_trajectory: {
          current_phase: "développement actif",
          next_milestones: ["optimisation routine", "équilibre vie"],
          long_term_potential: "expert productivité personnelle"
        }
      };
